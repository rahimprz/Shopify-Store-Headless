...
export function StatisticsSection() {
  ...
  return (
    <section
      ...
      className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden"
    >
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div
          className="absolute bottom-20 right-10 text-[150px] font-bold text-gray-300 cal-sans transform rotate-12 select-none animate-pulse"
        ...
        <div
          className="absolute top-1/4 right-1/4 w-32 h-32 bg-gradient-to-br from-amber-200 to-orange-200 rounded-full opacity-30 animate-bounce"
          style={{ animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-1/3 left-1/3 w-24 h-24 bg-gradient-to-br from-orange-200 to-amber-200 rounded-full opacity-40 animate-bounce"
          style={{ animationDuration: "4s", animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-16 h-16 bg-gradient-to-br from-amber-300 to-orange-300 rounded-full opacity-35 animate-bounce"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-16 lg:mb-20">
          ...
          <AnimatedSection animation="slideInUp" delay={200}>
            <div className="text-center group hover:scale-105 transition-all duration-500 cursor-pointer">
              <div className="relative mb-6 p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 hover:border-amber-200 transition-all duration-500">
                ...
                <div className="relative z-10">
                  <div className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 cal-sans leading-none mb-2 group-hover:text-[#caa05c] transition-colors duration-500">
                    {counters.years}+
                  </div>
                  <div className="absolute -top-2 -right-2 w-4 h-4 bg-[#caa05c] rounded-full animate-ping"></div>
                  <div className="absolute -top-2 -right-2 w-4 h-4 bg-[#caa05c] rounded-full"></div>
                </div>
              </div>
              <h3 className="text-xl lg:text-2xl font-bold text-gray-900 cal-sans mb-4 group-hover:text-[#caa05c] transition-colors duration-300">
                Years Experience
              </h3>
            ...
            <div className="text-center group hover:scale-105 transition-all duration-500 cursor-pointer">
              <div className="relative mb-6 p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl border border-gray-100 hover:border-amber-200 transition-all duration-500">
                ...
                <div className="relative z-10">
                  <div className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 cal-sans leading-none mb-2 group-hover:text-[#caa05c] transition-colors duration-500">
                    {counters.projects}
                    <span className="text-[#caa05c]">+</span>
                  </div>
                  <div
                    className="absolute -top-2 -right-2 w-4 h-4 bg-[#caa05c] rounded-full animate-ping"
        ...
        <AnimatedSection animation="scaleIn" delay={1000}>
          <div className="relative group">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-100 to-gray-200 hover:shadow-3xl transition-all duration-700 transform hover:scale-[1.02]">
              ...
              {/* Floating info cards */}
              <div
                className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl transform hover:scale-110 transition-all duration-300 animate-bounce"
                style={{ animationDuration: "3s" }}
              >
              ...
              <div
                className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl transform hover:scale-110 transition-all duration-300 animate-bounce"
              ...
              <div
                className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl transform hover:scale-110 transition-all duration-300 animate-bounce"
              ...
              <div
                className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl transform hover:scale-110 transition-all duration-300 animate-bounce"
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-2xl">
                  <div className="text-center">
                    ...
                    <div className="w-32 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-[#caa05c] rounded-full animate-pulse" style={{ width: "85%" }}></div>
                    </div>
                    <div className="w-12 h-0.5 bg-gradient-to-r from-transparent via-[#caa05c] to-[#caa05c]/70 animate-pulse"></div>
                    <div className="w-4 h-4 bg-[#caa05c] rounded-full animate-bounce shadow-lg"></div>
                    <div className="w-12 h-0.5 bg-gradient-to-r from-[#caa05c]/70 via-[#caa05c] to-transparent animate-pulse"></div>
                  </div>
                </div>
              </div>
              ...
              {/* Decorative Elements */}
              <div
                className="absolute -top-6 -right-6 w-16 h-16 bg-gradient-to-br from-amber-400/40 to-orange-500/40 rounded-full backdrop-blur-sm animate-spin"
                style={{ animationDuration: "8s" }}
              ></div>
              <div
                className="absolute -bottom-6 -left-6 w-12 h-12 bg-gradient-to-br from-orange-400/50 to-amber-500/50 rounded-full backdrop-blur-sm animate-spin"
                style={{ animationDuration: "6s", animationDelay: "1s", animationDirection: "reverse" }}
              ></div>
              <div
                className="absolute top-1/2 -right-4 w-8 h-8 bg-gradient-to-br from-amber-300/30 to-orange-400/30 rounded-full backdrop-blur-sm animate-bounce"
                style={{ animationDelay: "0.5s" }}
              ></div>
              <div
                className="absolute top-1/4 -left-4 w-6 h-6 bg-gradient-to-br from-orange-300/40 to-amber-400/40 rounded-full backdrop-blur-sm animate-bounce"
                style={{ animationDelay: "1.5s" }}
              ></div>
            </div>
          </div>
